...
// in tdd_first_project/test/features/number_trivia/presentation/blocs/number_trivia_bloc_test.dart.
...
import 'package:tdd_first_project/core/error/failures.dart' as _i6;
import 'package:tdd_first_project/core/usecases/usecase.dart' as _i10;
import 'package:tdd_first_project/core/util/input_converter.dart' as _i8;
...
class MockGetConcreteNumbertrivia extends _i1.Mock
  ...
  _i5.Future<_i3.Either<_i6.Failure, _i7.NumberTrivia>> execute(
          {int? number}) =>
      (super.noSuchMethod(Invocation.method(#execute, [], {#number: number}),
...
class MockInputConverter extends _i1.Mock implements _i8.InputConverter {
  ...
  @override
  _i3.Either<_i6.Failure, int> stringToUnsigned(String? str) =>
      (super.noSuchMethod(Invocation.method(#stringToUnsigned, [str]),
